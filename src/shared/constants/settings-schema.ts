...
export const SETTINGS_SCHEMA: Readonly<Record<string, SettingSpec>> = {
  ...
  block_recommendations_calls: { type: 'boolean', scopes: ADX },
  block_recommendations_profile: { type: 'boolean', scopes: ADX },
  block_recommendations_messenger: { type: 'boolean', scopes: ADX },
