...
// Иконка-закладка — узнаваемый символ «сохранить». Совпадает по силуэту
// с BookmarkIcon, который стоит у вкладки «Заметки» в попапе — пользователь
// сразу видит связь: нажал тут → нашёл там.
const ICON_PIN = `
  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    <path d="M12.5 14 8 11l-4.5 3V3a1 1 0 0 1 1-1h7a1 1 0 0 1 1 1z"/>
  </svg>
`;
// «Сохранено» — та же закладка, но залитая (filled). Сообщение «готово».
const ICON_DONE = `
  <svg viewBox="0 0 16 16" fill="currentColor" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round" aria-hidden="true">
    <path d="M12.5 14 8 11l-4.5 3V3a1 1 0 0 1 1-1h7a1 1 0 0 1 1 1z"/>
  </svg>
`;
