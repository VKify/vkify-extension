...
export default function Modal({
  ...
  const overlay = (
    ...
    >
      <div
        className={`w-full ${maxWidthClass} max-h-full bg-[var(--bg-primary)] rounded-2xl shadow-2xl border border-[var(--border-color)] overflow-hidden flex flex-col ${cardClassName}`}
