...
/**
 * Реестр страниц хаба «Скрытие» — та же архитектура, что у хаба «Центр»
 * (см. ../center/pages.tsx): шелл (HidingTab) рендерит навигацию и активную
...
export function pageForAnchor(anchor: string): HidingPage | undefined {
  return HIDING_PAGES.find(p => p.anchors.includes(anchor));
}
