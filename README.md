...
- Каждый переключатель подробно описывает скрываемые блоки. В сообществах скрывается блок «Похожие сообщества» и следующий элемент; в музыке — баннеры подписки, промопредложения, «Слушайте друг друга» и звуковая реклама между треками
